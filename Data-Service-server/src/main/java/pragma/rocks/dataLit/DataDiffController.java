...
import pragma.rocks.dataLit.container.Edge;
import pragma.rocks.dataLit.container.Node;
import pragma.rocks.dataLit.container.Provenance;
import pragma.rocks.dataLit.response.ProvenanceResponse;
...
public class DataDiffController {
	...
	public ProvenanceResponse DOcomparison(@RequestParam(value = "PID1", required = true) String PID1,
	...
	public Provenance diffProvenance(Provenance provenance1, Provenance provenance2) {
		return null;
	}
}
